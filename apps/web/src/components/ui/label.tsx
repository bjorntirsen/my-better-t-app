/** biome-ignore-all lint/a11y/noLabelWithoutControl: This is a reusable Label primitive. The associated control (via htmlFor or nesting) is provided by the consuming component. */
"use client";
